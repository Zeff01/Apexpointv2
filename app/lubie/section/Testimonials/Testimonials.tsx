...
import Cardslide from "@/app/chlorelief/section/Testimonials/cardslides";

function Testimonials() {
  return (
    <div className="testimonials min-h-screen flex flex-col justify-center items-center h-full w-full bg-lubie-light-blue border-2 pt-4 pb-8">
