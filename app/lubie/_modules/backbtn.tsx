...
const links = [
  {
    ...
    href: "#home",
    hover:
      "flex flex-col items-start px-10 mb-4 text-blue-700 hover:text-blue-200 ease-in-out duration-700",
  },
  {
    text: "Products",
    href: "#product",
...
const BackBtn = () => {
  ...
  return (
    <main className="flex bg-lubie-navy-blue white  items-center justify-between -z-0">
      <Link
        href="/"
        className=" flex items-center gap-2 pt-2 sm:px-20 sm:gap-4 lg:pt-10"
      >
        <Image src={goBackImg} alt="Go back to Apexpoint" />
        <p className="text-sm text-chlorelief-light-red sm:text-lg">
          Back to Apexpoint
        </p>
      </Link>
      {/* <MobileNav navMenu={navMenu} setNavMenu={setNavMenu} links={links} /> */}{" "}
      {/* to fix the imported file module */}
    </main>
  );
};
