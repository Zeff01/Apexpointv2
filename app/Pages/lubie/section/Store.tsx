...
return (
    <div className=' md:flex hidden flex-col  justify-center items-center mt-12'>
        <hr className="w-11/12 h-0.5 mx-2 my-6 bg-gray-300"></hr>
        <div className='text-4xl text-lubie-light-blue'>Available Stores</div>
        <div className='px-10 md:px-0 md:flex md:flex-row grid grid-cols-2 justify-center items-center gap-12 py-10'>
