...
export default function Product() {
  ...
  return (
    <>
      <div id="product" className="flex flex-col lg:h-[160vh] md:h-[140vh] sm:h-[140vh] xl:h-[100vh]">
        ...
        <div className="flex flex-col items-center justify-center text-center text-gray-500 w-full sm:text-[11px] lg:text-2xl py-0 sm:text-sm sm:text-center sm:py-6 md:py-0 lg:pb-8">
