...
function Testimonials() {
  return (
    <div className="testimonials min-h-screen flex flex-col justify-center items-center h-full w-full bg-green-200 border-2 pt-4">
      <div className="container flex flex-col justify-between items-center text-center lg:flex-row lg:text-start gap-4">
              <div>
              <p className="text-Body-Desktop text pt-2 font-medium">CUSTOMERS REVIEW</p>
          ...
          <div className="right text-Body-Default w-4/5 lg:w-1/3 my-4">
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Saepe magni aliquam hic, temporibus nemo omnis, consequatur voluptate tempore exercitationem nesciunt natus ipsa aut perspiciatis reiciendis fugit earum. Repellat, nam? Nisi.</p>
          </div>
      </div>
