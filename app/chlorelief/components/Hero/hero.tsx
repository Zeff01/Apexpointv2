...
const Data: HeroSectionProps[] = [
  {
    ...
    Text5: "sitametamet",
    TextStyle: "flex flex-col gap-1 items-center text-white opacity-90 text-Caption-Desktop",
        ...
        <div key={index} className={item.SectionClass}>
          <div className="flex justify-end flex-col-reverse sm:flex-row sm:items-center">
            <div className="flex flex-col justify-end items-center max-w-full-lg w-full gap-2">
              <h1 className="text-white text-Header-Mobile font-extrabold text-center pb-6 sm:text-Header-Default">{item.HeaderText}</h1>
