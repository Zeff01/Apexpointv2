...
import { FadeStagger, fadeInOutRightToLeft } from '@/components/animation/animation';
...
const ContactForm = () => {
  ...
  return (
    ...
    >
      <InputRow>
        <TextInput label="Name" name="user_name" id="name" type="text" placeholder="Enter your Name" ref={userName} />
      </InputRow>
      ...
      <InputRow className="min-h-[11rem]">
        <TextArea label="Message" name="message" id="textarea" placeholder="Enter your Message" ref={userMessage} />
      </InputRow>
